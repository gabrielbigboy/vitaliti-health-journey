...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vitaliti Saúde" },
      {
        name: "description",
        content:
          "Vitaliti Saúde — plataforma digital de saúde, nutrição e acompanhamento profissional.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,500;12..96,600;12..96,700;12..96,800&family=Instrument+Sans:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500;600&display=swap",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Vitaliti Saúde",
          description:
            "Plataforma digital de saúde focada em controle de peso, nutrição, saúde metabólica e mudança de hábitos.",
        }),
      },
    ],
  }),
