  ...
  return (
    <Section tone="default">
      ...
      <div className="mt-10 grid gap-4 lg:grid-cols-2">
        <div className="rounded-3xl border border-primary/25 bg-primary-soft p-6 md:p-8">
          <h3 className="text-lg font-semibold text-primary-deep">Com a Vitaliti</h3>
          <ul className="mt-6 space-y-3.5">
            {vitaliti.map((item) => (
              <li key={item} className="flex items-start gap-3 text-sm font-medium text-primary-deep">
